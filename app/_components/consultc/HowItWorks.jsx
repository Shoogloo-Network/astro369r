        ...
        <div className="how-it-works-content">
          <div className="how-it-works-icon-section">
            <div className="how-it-works-step-1">
              <i className="fa-solid fa-hand-pointer how-it-works-icon-1"></i>
            </div>
          ...
          <div className="how-it-works-icon-section">
            <div className="how-it-works-step-2">
              <i className="fa-solid fa-message how-it-works-icon-2"></i>
            </div>
          ...
          <div className="how-it-works-icon-section">
            <div className="how-it-works-step-3">
              <i className="fa-solid fa-file-prescription how-it-works-icon-3"></i>
            </div>
